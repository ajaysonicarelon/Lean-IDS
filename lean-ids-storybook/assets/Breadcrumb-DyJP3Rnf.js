import{j as s}from"./jsx-runtime-DSvmvvsx.js";import{g as p}from"./styled-components.browser.esm-CuwBLqEg.js";const l=p.span`
...
`,u=({label:e,isActive:r=!1,href:t,onClick:o,className:i})=>{const n=a=>{if(r){a.preventDefault();return}o&&(a.preventDefault(),o())};return t&&!r?s.jsx(l,{as:"a",href:t,$isActive:r,onClick:n,className:i,"aria-current":r?"page":void 0,children:e}):s.jsx(l,{$isActive:r,onClick:n,className:i,"aria-current":r?"page":void 0,children:e})};u.__docgenInfo={description:"",methods:[],displayName:"Breadcrumb",props:{label:{required:!0,tsType:{name:"string"},description:""},isActive:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},href:{required:!1,tsType:{name:"string"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};export{u as B};
