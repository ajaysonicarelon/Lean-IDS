---
name: lean-ds-elevance-design-system
description: Generate UI screens and components that match the Lean DS Elevance brand visual design system — including colors, typography, spacing, shadows, and component patterns. Use this skill whenever building healthcare enterprise applications that need to follow Elevance's design language with WCAG 2.1 AA accessibility compliance.
---

# Lean DS - Elevance Design System

## Skill Objective

Produce UI screen specs, component blueprints, or full page layouts that faithfully replicate the **Lean DS Elevance** design language. This is a healthcare-focused, enterprise-grade design system built for accessibility, consistency, and professional aesthetics. All tokens below are semantic tokens that map to the Elevance brand theme.
...
| Token | Hex | Role |
|-------|-----|------|
| `background.primary` | `#F6F6FA` | Main page background - primary-50 (Elevance blue tint) |
...
| `border.focus` | `#1A3673` | Focus borders - primary-500 |
...
| Token | Hex | Role |
|-------|-----|------|
| `interactive.default` | `#1A3673` | Default interactive - primary-500 (Elevance navy blue) |
| `interactive.hover` | `#15285C` | Hover state - primary-600 |
| `interactive.active` | `#102045` | Active/pressed state - primary-700 |
...
#### Brand Primary Scale (Elevance Navy Blue)

| Token | Hex | Usage |
|-------|-----|-------|
| `primary.50` | `#F6F6FA` | Lightest background |
| `primary.100` | `#EBEBF1` | Light background |
| `primary.200` | `#BAC3D5` | Subtle accents |
| `primary.300` | `#51729D` | Muted interactive |
| `primary.400` | `#314A81` | Secondary interactive |
| `primary.500` | `#1A3673` | **Main brand color** |
| `primary.600` | `#15285C` | Hover state |
| `primary.700` | `#102045` | Active state |
| `primary.800` | `#0A162E` | Deep accent |
| `primary.900` | `#081023` | Darkest |
...
**Primary:**
- Background: `interactive.default` (#1A3673 - Elevance navy blue)
- Text: `text.inverse` (#FFFFFF)
- Hover: `interactive.hover` (#15285C)
- Active: `interactive.active` (#102045)
...
**Tertiary:**
- Background: `transparent`
- Text: `interactive.default` (#1A3673)
- Hover: Background `primary.50` (#F6F6FA)
- Active: Background `primary.100` (#EBEBF1)
- Disabled: Text `text.disabled`

**Button Types (Contextual):**
- **Default:** Uses primary navy blue colors
...
- **Checked:** Background `interactive.default` (#1A3673), checkmark `text.inverse` (#FFFFFF)
- **Indeterminate:** Background `interactive.default` (#1A3673), dash `text.inverse` (#FFFFFF)
...
- **Selected:** Border `interactive.default` (#1A3673), inner dot `interactive.default` (8px diameter)
- **Disabled:** Border `border.disabled`, background `background.disabled`, opacity 0.4
...
- **On:** Track `interactive.default` (#1A3673), thumb `background.secondary` (#FFFFFF), thumb position right
...
- Item selected: Background `primary.50` (#F6F6FA), text `interactive.default` (#1A3673)
...
Colors:      7 color variants (navy, blue, green, yellow, red, cyan, terracotta)
States:      Default only
```

**Color Variants:**
- **Navy:** Background `primary.100` (#EBEBF1), text `primary.700` (#102045)
...
- **Row Selected:** Background `primary.50` (#F6F6FA), border-left `interactive.default` (4px)
...
Link Color:  interactive.default (#1A3673)
...
**States:**
- **Link Default:** Color `interactive.default` (#1A3673)
- **Link Hover:** Color `interactive.hover` (#15285C), underline
- **Link Active:** Color `interactive.active` (#102045)
...
Color:       interactive.default (#1A3673)
...
**States:**
- **Default:** Color `interactive.default` (#1A3673), no underline
- **Hover:** Color `interactive.hover` (#15285C), underline
- **Active:** Color `interactive.active` (#102045)
- **Visited:** Color `primary.700` (#102045)
...
- **Active:** Color `interactive.default` (#1A3673), border-bottom `interactive.default` (2px)
...
- **Hover:** Background `neutral.200` (#F8F8F8)
- **Active (current page):** Background `interactive.default` (#1A3673), text `text.inverse` (#FFFFFF)
...
1. **Clean white base** — `#FFFFFF` is the primary background for content areas, with `#F6F6FA` (primary-50) for page backgrounds
2. **Elevance navy blue brand** — `#1A3673` is the primary interactive color throughout
...
### Step 1 — Apply Elevance theme
Use Elevance navy blue (`#1A3673`) as the primary interactive color. Use `#F6F6FA` (primary-50) for page backgrounds and `#FFFFFF` for content areas.
...
Use semantic tokens:
- Text → `text.primary` (#222222)
- Backgrounds → `background.primary` (#F6F6FA), `background.secondary` (#FFFFFF)
- Interactive → `interactive.default` (#1A3673)
...
### Example: Login Form
```
Background:     background.primary (#F6F6FA - page), background.secondary (#FFFFFF - card)
...
Button:         variant primary, size medium, full width
                Background interactive.default (#1A3673), text text.inverse (#FFFFFF)
Link:           paragraph.regular (14px), color interactive.default (#1A3673)
...
Value:          displayS.semibold (48px, 600), color interactive.default (#1A3673)
...
Row Selected:   Background primary.50 (#F6F6FA), border-left interactive.default (4px)
Sort Icon:      Material Icons chevron, color interactive.default (#1A3673)
Pagination:     Bottom, buttons radius.sm (4px), active background interactive.default
```

---

*Design tokens extracted from Lean DS Elevance theme — built for healthcare enterprise applications with React + TypeScript + Styled Components*
