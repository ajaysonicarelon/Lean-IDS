...
```bash
npm install @ajaysoni7832/lean-ids-tokens@1.1.0
```

**Note:** The components package (`@ajaysoni7832/lean-ids-components`) is React-based. For Angular, use the tokens and follow the Angular implementation guide below.
...
import { theme, colors, spacing, typography } from '@ajaysoni7832/lean-ids-tokens';
...
let scss = '// Auto-generated from @ajaysoni7832/lean-ids-tokens\n\n';
...
import { theme as carelonTheme } from '@ajaysoni7832/lean-ids-tokens';
...
### **Documentation:**
- **Tokens Package:** https://www.npmjs.com/package/@ajaysoni7832/lean-ids-tokens
