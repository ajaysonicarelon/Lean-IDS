...
✅ **MUST** use `Modal` or `Drawer` from `@ajaysoni7832/lean-ids-components`  
...
- [ ] All modals use `Modal` from `@ajaysoni7832/lean-ids-components`
- [ ] All drawers use `Drawer` from `@ajaysoni7832/lean-ids-components`
...
**REMEMBER:**
1. ✅ **ALWAYS** use `Modal` from `@ajaysoni7832/lean-ids-components` for popups
2. ✅ **ALWAYS** use `Drawer` from `@ajaysoni7832/lean-ids-components` for side panels
