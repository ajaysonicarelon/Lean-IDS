...
[![npm version](https://img.shields.io/npm/v/lean-ids-components.svg)](https://www.npmjs.com/package/lean-ids-components)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)

## 📦 Installation

```bash
npm install lean-ids-components lean-ids-tokens styled-components
```
...
import { GlobalStyles } from 'lean-ids-components';
...
```tsx
import { Button, Avatar, Badge, InputField } from 'lean-ids-components';
...
- Don't forget to install `lean-ids-tokens`
