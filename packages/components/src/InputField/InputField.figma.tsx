// url=https://www.figma.com/design/krtBe5bwqddbHpFjYC5S13/Lean---IDS?node-id=1054-638&m=dev
import figma from "@figma/code-connect"
import { Search } from "@mui/icons-material"
import { InputField } from "./InputField"

// Figma property names fetched via: figma connect create (token auto-read from .env)
// Component name in Figma: "Input Field"
//
...
//   "Lead Icon (s/m)"       → instance swap → skipped (no code equivalent)
//   "Trail Icon (s/m)"      → instance swap → skipped (no code equivalent)

figma.connect(
  InputField,
  "https://www.figma.com/design/krtBe5bwqddbHpFjYC5S13/Lean---IDS?node-id=1054-638&m=dev",
  {
    props: {
