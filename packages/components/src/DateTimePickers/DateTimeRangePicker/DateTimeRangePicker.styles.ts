/**
 * DateTimeRangePicker Component Styles
 */

import styled from 'styled-components';

interface RangePickerContainerProps {
  $showQuickSelect?: boolean;
}

export const RangePickerContainer = styled.div<RangePickerContainerProps>`
  display: inline-flex;
  width: ${({ $showQuickSelect }) => ($showQuickSelect ? '896px' : '696px')};
...
export const RangePickerContent = styled.div`
  display: flex;
  width: 100%;
`;

export const CalendarsSection = styled.div`
  display: flex;
...
export const RangeDisplayRow = styled.div`
  display: flex;
  width: 100%;
`;
...
export const QuickSelectPanel = styled.div`
  ...
  flex-direction: column;
  justify-content: space-between;
  padding: ${({ theme }) => `${theme.spacing[7]} ${theme.spacing[5]} ${theme.spacing[7]} ${theme.spacing[10]}`};
  background: ${({ theme }) => theme.colors.palette.primary[50]};
  min-width: 150px;
`;
...
export const QuickSelectItem = styled.button`
  font-family: ${({ theme }) => theme.typography.body.medium.fontFamily};
  font-size: ${({ theme }) => theme.typography.body.medium.fontSize};
  font-weight: ${({ theme }) => theme.typography.body.medium.fontWeight};
  line-height: ${({ theme }) => theme.typography.body.medium.lineHeight};
...
export const ActionsRow = styled.div`
  ...
  padding: ${({ theme }) => `0 ${theme.spacing[7]} ${theme.spacing[7]} ${theme.spacing[7]}`};
  width: 100%;
`;
