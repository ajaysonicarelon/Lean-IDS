...
### **1. lean-ids-tokens@1.1.0**
- **npm:** https://www.npmjs.com/package/lean-ids-tokens
- **Size:** 17.6 KB
- **Files:** 33
- **Install:** `npm install lean-ids-tokens`

### **2. lean-ids-components@1.1.0**
- **npm:** https://www.npmjs.com/package/lean-ids-components
- **Size:** 87.4 KB
- **Files:** 190
- **Install:** `npm install lean-ids-components`
...
- **Installation:** `npm install lean-ids-components lean-ids-tokens`
- **Template:** `packages/components/src/Table/README_TABLE_TEMPLATE.md`
- **npm:** https://www.npmjs.com/package/lean-ids-components

### **For Angular Developers:**
- **Installation:** `npm install lean-ids-tokens`
...
### **npm Registry:**
- Tokens: https://www.npmjs.com/package/lean-ids-tokens
- Components: https://www.npmjs.com/package/lean-ids-components
...
```tsx
import { Button, DataTable } from 'lean-ids-components';
...
# Test imports
node -e "console.log(require('lean-ids-tokens'))"
node -e "console.log(require('lean-ids-components'))"
```
...
### **React Developers:**
1. Install packages: `npm install lean-ids-components lean-ids-tokens`
...
### **Angular Developers:**
1. Install tokens: `npm install lean-ids-tokens`
...
- Dependencies: styled-components, lucide-react, lean-ids-tokens
- TypeScript: ✅
- Tree-shakeable: ✅
- React: 18+
